...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_PERSONA` (
  `ID_PERSONA` INT NOT NULL AUTO_INCREMENT, ----sin autoincrement
  `NOMBRE` VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_EDITORIAL` (
  ...
  `PAIS` VARCHAR(50) NOT NULL,  ---------------puede ser null
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_MATERIAL` (
  ...
  `EDICION` VARCHAR(45) NOT NULL,                                ------------puede ser null
  `NIVEL` ENUM('BASICO', 'INTERMEDIO', 'AVANZADO') NOT NULL COMMENT 'A:BASICO\\nB:INTERMEDIO\\nC:AVANZADO', -----sin comentarios / puede ser null
  `ANHIO_PUBLICACION` INT NOT NULL,                              -----------------puede ser null
  `EDITORIAL_IDEDITORIAL` INT NOT NULL,                          -----------------puede ser null
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_TEMA` (
  ...
  `CATEGORIA` ENUM('GENERO', 'EDAD') NOT NULL COMMENT 'A:GENERO\\nB:EDAD', ------sin comentarios
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_EJEMPLAR` (
  ...
  `FECHA_ADQUISICION` DATE NOT NULL,                ------------------puede ser null
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_SANCION` (
  ...
  `TIPO` ENUM('DANHO', 'PERDIDA', 'DEMORA', 'EXCEPCION') NOT NULL COMMENT 'A:DANHO\\nB:PERDIDA\\nC:DEMORA\\nD:EXCEPCION',       ----sin comentarios
  `FECHA` DATE NOT NULL,
  `MONTO` DOUBLE NULL DEFAULT NULL,
  `DURACION` DATE NOT NULL,           ---------puede ser null
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_AUTOR` ( ------------BIB_CREADOR
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_PRESTAMO_EJEMPLAR` (
  ...
  `ESTADO` ENUM('SOLICITADO', 'PRESTADO', 'DEVUELTO', 'ATRASADO') NOT NULL COMMENT 'A:SOLICITADO\\nB:PRESTADO\\nC:DEVUELTO\\nD:ATRASADO', --------quitar comentario
  `FECHA_REAL_DEVOLUCION` DATE NOT NULL,            -----------------puede ser null, empieza como null
