...
DROP PROCEDURE IF EXISTS SP_BIB_INSERTAR_DATOS_PRUEBA_REPORTE_GENERAL$$

CREATE PROCEDURE SP_BIB_INSERTAR_DATOS_PRUEBA_REPORTE_GENERAL()
BEGIN
    ...
    -- Insertar en la tabla de reporte general (sin sede)
    INSERT INTO BIB_REPORTE_GENERAL (ANHIO, MES, PRESTAMO_IDPRESTAMO, PERSONA_IDPERSONA)
    VALUES 
        (2025, 5, v_idPrestamo1, v_idPersona1),
        (2025, 5, v_idPrestamo2, v_idPersona2),
        (2025, 5, v_idPrestamo3, v_idPersona3),
        (2025, 5, v_idPrestamo4, v_idPersona4);
END$$
